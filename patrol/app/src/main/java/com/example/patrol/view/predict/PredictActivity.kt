...
class PredictActivity : AppCompatActivity() {
    ...
    private val viewModels by lazy { ViewModelProvider(this).get(PredicitViewModel::class.java) }
    ...
    private fun refreshData(lat: Double, lon: Double) {
        // Get actual data
        viewModels.getPredict(lat.toString(), lon.toString())
        viewModels.predictLiveData.observe(this, Observer { result ->
            val crowdData = result.getOrNull()
            if (crowdData != null) {
